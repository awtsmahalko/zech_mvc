  ...
  <!-- DataTables -->
  <link type="text/css" rel="stylesheet" href="<?=BASE_PATH?>assets/plugins/datatables/jquery.dataTables.min.css">
...
function modal_show(to_remove = 'modal-md',to_add = 'modal-lg'){
...
function sql_data_add(tbl,item_data,func = "", param = []){
    ...
    function logOut(){
        Swal.fire({
        title: 'Are you sure to Log Out Account?',
